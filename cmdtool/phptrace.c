	...
	while (1)
	{
		...
		switch (flag)
		{
			...
			default:
				...
				if (flag != seq + 1)
				{
					error_msg_and_die("[error] record seq error!\n");
				}
...
int main(int argc, char *argv[])
{
	/* 
	// str test 
	phptrace_str_t *str = phptrace_string("abcde");
	phptrace_str_print(str);
	phptrace_str_free(str);	
	return 0;
	*/
