...
> call_normal(object(Closure)#1) called at [%s:5]
    < call_normal(object(Closure)#1) = NULL called at [%s:5] wt: %f
    > call_user_func(object(Closure)#1) called at [%s:9]
        > {closure:%s:7-9}() called at [%s:9]
            > call_normal() called at [%s:8]
            < call_normal() = NULL called at [%s:8] wt: %f
        < {closure:%s:7-9}() = NULL called at [%s:9] wt: %f
    < call_user_func(object(Closure)#1) = NULL called at [%s:9] wt: %f
